...
function FirstInfoPunel() {
  return (
    <body className={style.Conteiner}>
        <div className={style.InfoConteiner}>
          <div className={style.Blockquote}>
            <div>
              <span className={style.Thin}>
                Great{" "}
                <span
                  className={`${style.SettingsGradient} + ${style.FirstGradient}`}
                >
                  Product
                </span>{" "}
                is
            ...
            <div>
              <b className={style.Bold}>built by great</b>{" "}
              <span
                className={`${style.SettingsGradient} + ${style.SecondGradient}`}
              >
                teams
              </span>
            </div>
